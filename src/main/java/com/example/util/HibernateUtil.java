...
/**
 * Утилита для инициализации Hibernate SessionFactory
 * Поддерживает как обычную конфигурацию, так и тестовую
 */
    ...
    static {
        try {
            ...
            try {
                ...
                System.out.println("Сущность UserEntity зарегистрирована в Hibernate!");
            } catch (Exception e) {
